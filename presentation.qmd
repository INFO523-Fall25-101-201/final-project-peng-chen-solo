...
2   Male         19416 non-null  object    
3   BMI          19416 non-null  float64  
4   Age          19416 non-null  float64  
5   OSA          19416 non-null  object    
6   APOE_e4      19416 non-null  object    
7   snoring      19416 non-null  object  
...
dtypes: float64(30), object(5) memory usage: 5.3+ MB 
OSA 
0    19280 
1      136 
...
![](images/ukb_synthesizer_osa_loss.png){fig-align="center" width="756"}
:::
...
## 4. Real x Synthetic cross-domain validation
...
-   Real model identified every record as healthy control (TP=0, FP=0).
